...
public:
    ...
    SceneLayer(int viewportWidth, int viewportHeight) {
        ...
        triangle1.addComponent<engine::ModelComponent>(engine::Triangle2DModel());
        ...
        triangle2.addComponent<engine::ModelComponent>(engine::Triangle2DModel());
        ...
        triangle3.addComponent<engine::ModelComponent>(engine::Triangle2DModel());
        ...
        square1.addComponent<engine::ModelComponent>(engine::Square2DModel());
        ...
        square2.addComponent<engine::ModelComponent>(engine::Square2DModel());
        ...
        square3.addComponent<engine::ModelComponent>(engine::Square2DModel());
