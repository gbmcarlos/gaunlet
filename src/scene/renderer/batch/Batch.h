...
namespace engine {
    ...
    struct PolygonEntityProperties {
        ...
        PolygonEntityProperties(unsigned int entityId, const glm::mat4& transform, glm::vec4 color)
        ...
        unsigned int m_entityId; glm::vec2 pad2 = {};
    };

    struct CircleEntityProperties {

        CircleEntityProperties(unsigned int entityId, const glm::mat4& transform, glm::vec4 color, float thickness, float fade)
